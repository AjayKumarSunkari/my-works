...
<head>
	...
	<script type="text/javascript" src="js/carz4U.js"></script>
</head>
...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<h1>Carz4U - Login Page</h1>

			<!-- <form method="post" onsubmit="getAction(this);" id="loginForm" name="loginForm"> -->
			<form method="post" id="loginForm" name="loginForm">
				...
				<button type="submit" onclick="login();loginResponse();">Login</button>
			</form>
